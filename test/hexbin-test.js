...
tape("hexbin(points) observes the current radius", function(test) {
  var bins = d3_hexbin.hexbin().radius(2)([
    [0, 0], [0, 1], [0, 2],
    [1, 0], [1, 1], [1, 2],
    [2, 0], [2, 1], [2, 2]
  ]);
...
tape("hexbin.hexagon() returns the expected path", function(test) {
  test.pathEqual(d3_hexbin.hexbin().hexagon(), "m0,-1l0.866025,0.500000l0,1l-0.866025,0.500000l-0.866025,-0.500000l0,-1z");
  test.end();
});

tape("hexbin.hexagon() observes the current bin radius", function(test) {
  test.pathEqual(d3_hexbin.hexbin().radius(2).hexagon(), "m0,-2l1.732051,1l0,2l-1.732051,1l-1.732051,-1l0,-2z");
  test.pathEqual(d3_hexbin.hexbin().radius(4).hexagon(), "m0,-4l3.464102,2l0,4l-3.464102,2l-3.464102,-2l0,-4z");
  test.end();
});

tape("hexbin.hexagon(radius) observes the specified radius", function(test) {
  test.pathEqual(d3_hexbin.hexbin().hexagon(2), "m0,-2l1.732051,1l0,2l-1.732051,1l-1.732051,-1l0,-2z");
  test.pathEqual(d3_hexbin.hexbin().hexagon(4), "m0,-4l3.464102,2l0,4l-3.464102,2l-3.464102,-2l0,-4z");
  test.end();
});

tape("hexbin.hexagon(radius) uses the current bin radius if radius is null", function(test) {
  test.pathEqual(d3_hexbin.hexbin().hexagon(null), "m0,-1l0.866025,0.500000l0,1l-0.866025,0.500000l-0.866025,-0.500000l0,-1z");
  test.pathEqual(d3_hexbin.hexbin().hexagon(undefined), "m0,-1l0.866025,0.500000l0,1l-0.866025,0.500000l-0.866025,-0.500000l0,-1z");
  test.end();
});

tape("hexbin.centers() returns an array of bin centers", function(test) {
  test.deepEqual(d3_hexbin.hexbin().centers(), [
    [0, 0],
...
tape("hexbin.centers() observes the current bin radius", function(test) {
  test.deepEqual(d3_hexbin.hexbin().radius(0.5).centers(), [
    [0, 0],
...
tape("hexbin.centers() observes the current extent", function(test) {
  test.deepEqual(d3_hexbin.hexbin().radius(0.5).extent([[-1.1, -1.1], [1.1, 1.1]]).centers(), [
    [-0.4330127018922193, -0.75],
    [0.4330127018922193, -0.75],
    [1.299038105676658, -0.75],
    [-0.8660254037844386, 0],
...
tape("hexbin.mesh() returns the expected path", function(test) {
  test.pathEqual(d3_hexbin.hexbin().mesh(), "M0,0m0,-1l0.866025,0.500000l0,1l-0.866025,0.500000M1.732051,0m0,-1l0.866025,0.500000l0,1l-0.866025,0.500000M0.866025,1.500000m0,-1l0.866025,0.500000l0,1l-0.866025,0.500000");
  test.end();
});

tape("hexbin.mesh() observes the bin radius", function(test) {
  test.pathEqual(d3_hexbin.hexbin().radius(0.5).mesh(), "M0,0m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M0.866025,0m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M0.433013,0.750000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M1.299038,0.750000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000");
  test.end();
});

tape("hexbin.mesh() observes the extent", function(test) {
  test.pathEqual(d3_hexbin.hexbin().radius(0.5).extent([[-1.1, -1.1], [1.1, 1.1]]).mesh(), "M-0.433013,-0.750000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M0.433013,-0.750000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M1.299038,-0.750000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M-0.866025,0m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M0,0m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M0.866025,0m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M-0.433013,0.750000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M0.433013,0.750000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M1.299038,0.750000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M-0.866025,1.500000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M0,1.500000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000M0.866025,1.500000m0,-0.500000l0.433013,0.250000l0,0.500000l-0.433013,0.250000");
  test.end();
});
